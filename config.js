...
module.exports = {
    ...
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'SHADOWWALKER ' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    ...
    OWNER: process.env.OWNER === undefined ? `263714183261` : process.env.OWNER, //BOTS OWNER NUMBER
